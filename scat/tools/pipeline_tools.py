...
def rerender_report(results_dir: str, primary_metric: Optional[str] = None,
                    ...
                    show_ns: bool = False, condition_matrix: Optional[dict] = None,
                    palette: Optional[dict] = None, n_flies=None,
